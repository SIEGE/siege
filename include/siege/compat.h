...
#define sgDrawRectangle(x1, y1, x2, y2, fill)               sgDrawRectangle2f(x2, y2, x2, y2, fill)
#define sgDrawRectangleWH(x1, y1, x2, y2, fill)             sgDrawRectangle2fWH(x2, y2, x2, y2, fill)
#define sgDrawRectangleRound(x1, y1, x2, y2, rx, ry, fill)   sgDrawRectangleRound2f(x2, y2, x2, y2, rx, ry, fill)
#define sgDrawRectangleRoundWH(x1, y1, x2, y2, rx, ry, fill) sgDrawRectangleRound2fWH(x2, y2, x2, y2, rx, ry, fill)
